...
const char *catalog_path = "/home/adisuper/Courses/DBI/Project/Project1/catalog";
const char *tpch_dir ="/home/adisuper/Courses/DBI/Project/tpch-dbgen/"; // dir where dbgen tpch files (extension *.tbl) can be found
const char *dbfile_dir = "/home/adisuper/Courses/DBI/Project/tpch-dbgen/uf/test/";
using namespace std;
